    ...
    ph === "idle"
      ...
      : ph === "declare"
        ? state.runStep >= 2
          ...
          : "Заявите разряд, если хотите сузить жребий до своей заявки, или сразу бросьте куб: удобного снаряда всё равно не бывает."
        : ph === "over"
          ...
          : ph === "bout" || ph === "clash"
            ...
            : lot === null || ph !== "result"
              ? "Разряды заявлены. Бросьте куб: жребий выберет снаряд из двух заявленных."
