import { apiListOrEmpty, apiListWithOffline, apiRequestOrNull } from "@/lib/api";
...
export const listAthletesWithStatus = () => apiListWithOffline<Athlete>("/api/v1/athletes");
...
export const listClubsWithStatus = () => apiListWithOffline<Club>("/api/v1/clubs");

export const listRuleSets = () => apiListOrEmpty<RuleSet>("/api/v1/rulesets");

export const listRuleSetsWithStatus = () => apiListWithOffline<RuleSet>("/api/v1/rulesets");
...
export const listCoursesWithStatus = () => apiListWithOffline<Course>("/api/v1/courses");
