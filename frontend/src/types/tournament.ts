/**
 * Wire types mirroring the FastAPI response models for the tournaments
 * domain — competitions, participants, teams, matches, brackets, standings,
 * draws, entry-list import, and the жребий/bout detail views.
 *
...
import type { WeaponCategory } from "./equipment";
